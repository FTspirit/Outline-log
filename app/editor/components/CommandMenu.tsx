...
console.log(`47_editor/components/CommandMenu.tsx`);
...
class CommandMenu<T = MenuItem> extends React.Component<Props<T>, State> {
  ...
  componentDidMount() {
    console.log(`48_editor/components/CommandMenu.tsx_cpnDidmount`);
    window.addEventListener("keydown", this.handleKeyDown);
  }

  shouldComponentUpdate(nextProps: Props, nextState: State) {
    console.log(`49_editor/components/CommandMenu.tsx_shouldCpnDidmount`);
    return (
  ...
  componentDidUpdate(prevProps: Props) {
    console.log(`50_editor/components/CommandMenu.tsx_cpnDidUpdate`);
  ...
  componentWillUnmount() {
    console.log(`51_editor/components/CommandMenu.tsx_cpnWillunmount`);
    window.removeEventListener("keydown", this.handleKeyDown);
  }

  handleKeyDown = (event: KeyboardEvent) => {
    console.log(`52_editor/components/CommandMenu.tsx_handleKeyDown`);
  ...
  insertItem = (item: any) => {
    console.log(`53_editor/components/CommandMenu.tsx_insertItem`);
    switch (item.name) {
      case "image":
  ...
  close = () => {
    console.log(`54_editor/components/CommandMenu.tsx_close`);
    this.props.onClose();
    this.props.view.focus();
  };

  handleLinkInputKeydown = (event: React.KeyboardEvent<HTMLInputElement>) => {
    console.log(`55_editor/components/CommandMenu.tsx_handleLinkInputKeydown`);
    if (!this.props.isActive) {
      return;
    }
  ...
  handleLinkInputPaste = (event: React.ClipboardEvent<HTMLInputElement>) => {
    console.log(`56_editor/components/CommandMenu.tsx_handleLinkInputPaste`);
    if (!this.props.isActive) {
      return;
    }
    if (!this.state.insertItem) {
  ...
  triggerFilePick = (accept: string) => {
    console.log(`57_editor/components/CommandMenu.tsx_triggerFilePick`);
  ...
  triggerLinkInput = (item: EmbedDescriptor) => {
    console.log(`58_editor/components/CommandMenu.tsx_triggerLinkInput`);
    this.setState({ insertItem: item });
  };

  handleFilePicked = (event: React.ChangeEvent<HTMLInputElement>) => {
    console.log(`59_editor/components/CommandMenu.tsx_handleFilePicked`);
  ...
  clearSearch = () => {
    console.log(`60_editor/components/CommandMenu.tsx_clearSearch`);
    this.props.onClearSearch();
  };

  insertBlock(item: MenuItem) {
    console.log(`61_editor/components/CommandMenu.tsx_insertBlock`);
    this.clearSearch();
  ...
  get caretPosition(): { top: number; left: number } {
    console.log(`62_editor/components/CommandMenu.tsx_caretPosition`);
  ...
  calculatePosition(props: Props) {
    console.log(`63_editor/components/CommandMenu.tsx_calculatePosition`);
    const { view } = props;
  ...
  get filtered() {
    console.log(`64_editor/components/CommandMenu.tsx_filtered`);
    const {
      embeds = [],
      search = "",
      uploadFile,
  ...
  render() {
    console.log(`65_editor/components/CommandMenu.tsx_render`);
          ...
          {insertItem ? (
            ...
            <List>
              {items.map((item, index) => {
                ...
                const handlePointer = () => {
                  console.log(
                    `66_editor/components/CommandMenu.tsx_handlePointer`
                  );
