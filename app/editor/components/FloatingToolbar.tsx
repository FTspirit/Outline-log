...
console.log(`80_editor/components/FloatingToolbar.tsx`);
...
function usePosition({
  ...
  console.log(`80_editor/components/FloatingToolbar.tsx_usePosition`);
  ...
  if (
    ...
    console.log(`81_editor/components/FloatingToolbar.tsx_defaultPosition`);
  ...
  if (isTouchDevice && viewportHeight) {
    console.log(
      `82_editor/components/FloatingToolbar.tsx_isTouchDevice&&viewportHeight`
    );
    return {
      left: 0,
      right: 0,
  ...
  const isColSelection =
    ...
    selection.isColSelection() &&
    console.log(`80.1_editor/components/FloatingToolbar.tsx_isColSelection`);
  const isRowSelection =
    selection instanceof CellSelection &&
    selection.isRowSelection &&
    selection.isRowSelection() &&
    console.log(`80.2_editor/components/FloatingToolbar.tsx_isRolSelection`);

  if (isColSelection) {
    console.log(`83_editor/components/FloatingToolbar.tsx_isColSelection`);
  ...
  if (isRowSelection) {
    console.log(`84_editor/components/FloatingToolbar.tsx_isRowSelection`);
  ...
  if (isImageSelection) {
    console.log(`85_editor/components/FloatingToolbar.tsx_isImageSelection`);
    ...
    console.log(`86_editor/components/FloatingToolbar.tsx_!isImageSelection`);
...
const FloatingToolbar = React.forwardRef(
  (props: Props, forwardedRef: React.RefObject<HTMLDivElement>) => {
    console.log(`87_editor/components/FloatingToolbar.tsx_FloatingToolbar`);
