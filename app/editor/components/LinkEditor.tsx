...
console.log(`89_editor/components/LinkEditor.tsx_LinkEditor`);
...
class LinkEditor extends React.Component<Props, State> {
  ...
  get href(): string {
    console.log(`90_editor/components/LinkEditor.tsx_href`);
    return sanitizeUrl(this.props.mark?.attrs.href) ?? "";
  }

  get suggestedLinkTitle(): string {
    console.log(`91_editor/components/LinkEditor.tsx_suggestedLinkTitle`);
  ...
  componentWillUnmount = () => {
    console.log(`92_editor/components/LinkEditor.tsx_CpnWillUnmount`);
  ...
  handleKeyDown = (event: React.KeyboardEvent): void => {
    switch (event.key) {
      case "Enter": {
        console.log(`93_editor/components/LinkEditor.tsx_handleKeyDownEnter`);
      ...
      case "Escape": {
        console.log(`94_editor/components/LinkEditor.tsx_handleKeyDownEscape`);
        event.preventDefault();
      ...
      case "ArrowUp": {
        console.log(`95_editor/components/LinkEditor.tsx_handleKeyDownArrowUp`);
        if (event.shiftKey) {
          return;
        }
        event.preventDefault();
  ...
  handleFocusLink = (selectedIndex: number) => {
    console.log(`96_editor/components/LinkEditor.tsx_handleFocusLink`);
  ...
  handleChange = async (
    ...
    console.log(`97_editor/components/LinkEditor.tsx_handleChange`);
  ...
  handlePaste = (): void => {
    console.log(`98_editor/components/LinkEditor.tsx_handlePaste`);
    setTimeout(() => this.save(this.state.value, this.state.value), 0);
  };

  handleOpenLink = (event: React.MouseEvent<HTMLButtonElement>): void => {
    console.log(`98.1_editor/components/LinkEditor.tsx_handleOpenLink`);
    event.preventDefault();
  ...
  handleCreateLink = async (value: string) => {
    console.log(`99_editor/components/LinkEditor.tsx_handleOpenLink`);
    this.discardInputValue = true;
    const { onCreateLink } = this.props;
  ...
  handleRemoveLink = (): void => {
    console.log(`100_editor/components/LinkEditor.tsx_handleRemoveLink`);
    this.discardInputValue = true;
  ...
  handleSelectLink = (url: string, title: string) => (
    ...
    console.log(`101_editor/components/LinkEditor.tsx_handleSelectLink`);
    event.preventDefault();
    this.save(url, title);
  ...
  moveSelectionToEnd = () => {
    console.log(`102_editor/components/LinkEditor.tsx_moveSelectionToEnd`);
  ...
  render() {
    console.log(`103_editor/components/LinkEditor.tsx_render`);
