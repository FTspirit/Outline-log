...
console.log(`111_editor/components/SelectionToolbar.tsx`);
...
function isVisible(props: Props) {
  console.log(`112_editor/components/SelectionToolbar.tsx_isVisible`);
  const { view } = props;
...
export default class SelectionToolbar extends React.Component<Props> {
  ...
  componentDidUpdate(): void {
    console.log(
      `113_editor/components/SelectionToolbar.tsx_componentDidUpdate`
    );
  ...
  componentDidMount(): void {
    console.log(
      `114_editor/components/SelectionToolbar.tsx_ componentDidMount`
    );
  ...
  componentWillUnmount(): void {
    console.log(
      `115_editor/components/SelectionToolbar.tsx_ componentWillUnmount`
    );
  ...
  handleClickOutside = (ev: MouseEvent): void => {
    console.log(
      `116_editor/components/SelectionToolbar.tsx_handleClickOutside`
    );
    if (
  ...
  handleOnCreateLink = async (title: string): Promise<void> => {
    console.log(
      `117_editor/components/SelectionToolbar.tsx_handleOnCreateLink`
    );
  ...
  handleOnSelectLink = ({
    ...
    console.log(
      `118_editor/components/SelectionToolbar.tsx_handleOnSelectLink`
    );
    const { view } = this.props;
  ...
  render() {
    console.log(`119_editor/components/SelectionToolbar.tsx_render`);
    ...
    if (isTableSelection) {
      ...
      console.log(
        `119.1_editor/components/SelectionToolbar.tsx_isTableSelection`
      );
    } else if (colIndex !== undefined) {
      console.log(
        `119.2_editor/components/SelectionToolbar.tsx_getTableColMenuItems`
      );
      items = getTableColMenuItems(state, colIndex, rtl, dictionary);
    } else if (rowIndex !== undefined) {
      console.log(
        `119.3_editor/components/SelectionToolbar.tsx_getTableRowMenuItems`
      );
      items = getTableRowMenuItems(state, rowIndex, dictionary);
    } else if (isImageSelection) {
      console.log(
        `119.4_editor/components/SelectionToolbar.tsx_getImageMenuItems`
      );
      items = getImageMenuItems(state, dictionary);
    } else if (isDividerSelection) {
      console.log(
        `119.5_editor/components/SelectionToolbar.tsx_getDividerMenuItems`
      );
      items = getDividerMenuItems(state, dictionary);
    } else {
      console.log(
        `119.6_editor/components/SelectionToolbar.tsx_getFormattingMenuItems`
      );
