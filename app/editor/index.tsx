...
> {
  static defaultProps = {
    ...
    onFileUploadStart: () => {
      // no default behavior
      console.log(`1_index.tsx_fileUploadStart`);
    },
    onFileUploadStop: () => {
      // no default behavior
      console.log(`2_index.tsx_fileUploadStop`);
    },
    embeds: [],
  ...
  public componentDidMount() {
    console.log(`3_index.tsx_cpnDidmount`);
    this.init();
  ...
  public componentDidUpdate(prevProps: Props) {
    console.log(`3_index.tsx_cpnDidUpdate`);
  ...
  private createExtensions() {
    console.log(`5_index.tsx_CreateExtensions`);
    return new ExtensionManager(this.props.extensions, this);
  }

  private createPlugins() {
    console.log(`6_index.tsx_CreatePlugins`);
    return this.extensions.plugins;
  }

  private createRulePlugins() {
    console.log(`7_index.tsx_createRulePlugins`);
    return this.extensions.rulePlugins;
  }

  private createKeymaps() {
    console.log(`8_index.tsx_createKeymaps`);
  ...
  private createInputRules() {
    console.log(`9_index.tsx_createInputRules`);
  ...
  private createNodeViews() {
    console.log(`10_index.tsx_createNodeViews`);
  ...
  private createCommands() {
    console.log(`11_index.tsx_createCommands`);
  ...
  private createNodes() {
    console.log(`12_index.tsx_createNodes`);
    return this.extensions.nodes;
  }

  private createMarks() {
    console.log(`13_index.tsx_createMarks`);
    return this.extensions.marks;
  }

  private createSchema() {
    console.log(`14_index.tsx_createSchema `);
    return new Schema({
      nodes: this.nodes,
      marks: this.marks,
    });
  ...
  private createSerializer() {
    console.log(`15_index.tsx_createSerializer`);
    return this.extensions.serializer();
  }

  private createParser() {
    console.log(`16_index.tsx_createParser`);
  ...
  private createPasteParser() {
    console.log(`17_index.tsx_createPasteParser`);
    return this.extensions.parser({
      schema: this.schema,
  ...
  private createState(value?: string) {
    console.log(`18_index.tsx_createState`);
  ...
  private createDocument(content: string) {
    console.log(`19_index.tsx_createDocument`);
    return this.parser.parse(content);
  }

  private createView() {
    console.log(`20_index.tsx_createView`);
  ...
  public scrollToAnchor(hash: string) {
    console.log(`21_index.tsx_scrollToAnchor`);
    if (!hash) {
      return;
    }
  ...
  private calculateDir = () => {
    console.log(`22_index.tsx_calculateDir`);
    if (!this.element.current) {
      return;
    }
  ...
  public value = (): string => {
    console.log(`23_index.tsx_Value`);
    return this.serializer.serialize(this.view.state.doc);
  };

  private handleChange = () => {
    console.log(`24_index.tsx_handleChange`);
    if (!this.props.onChange) {
      return;
    }

    this.props.onChange(() => {
      console.log(`25_index.tsx_handleChangeOnChange`);
      return this.view ? this.value() : undefined;
    });
  };

  private handleEditorBlur = () => {
    console.log(`26_index.tsx_handleEditorBlur`);
    this.setState({ isEditorFocused: false });
    return false;
  };

  private handleEditorFocus = () => {
    console.log(`27_index.tsx_handleEditorFocus`);
    this.setState({ isEditorFocused: true });
    return false;
  };

  private handleOpenSelectionMenu = () => {
    console.log(`28_index.tsx_handleOpenSelectionMenu`);
    this.setState({ blockMenuOpen: false, selectionMenuOpen: true });
  };

  private handleCloseSelectionMenu = () => {
    if (!this.state.selectionMenuOpen) {
      console.log(`29_index.tsx_handleCloseSelectionMenu`);
      return;
    }
  ...
  private handleOpenEmojiMenu = (search: string) => {
    console.log(`30_index.tsx_handleOpenEmojiMenu`);
    this.setState({ emojiMenuOpen: true, blockMenuSearch: search });
  };

  private handleCloseEmojiMenu = () => {
    console.log(`31_index.tsx_handleCloseEmojiMenu`);
  ...
  private handleOpenLinkMenu = () => {
    console.log(`32_index.tsx_handleOpenLinkMenu`);
    this.setState({ blockMenuOpen: false, linkMenuOpen: true });
  };

  private handleCloseLinkMenu = () => {
    console.log(`33_index.tsx_handleCloseLinkMenu`);
    this.setState({ linkMenuOpen: false });
  };

  private handleOpenBlockMenu = (search: string) => {
    console.log(`34_index.tsx_handleOpenBlockMenu`);
    this.setState({ blockMenuOpen: true, blockMenuSearch: search });
  };

  private handleCloseBlockMenu = (insertNewLine?: boolean) => {
    console.log(`35_index.tsx_handleCloseBlockMenu`);
    if (insertNewLine) {
      console.log(`36_index.tsx_handleCloseBlockMenuInsertNewLine`);
    ...
    if (!this.state.blockMenuOpen) {
      console.log(`37_index.tsx_!blockMenuOpen`);
      return;
    }
  ...
  public focusAtStart = () => {
    console.log(`38_index.tsx_focusAtStart`);
  ...
  public focusAtEnd = () => {
    console.log(`39_index.tsx_focusAtEnd`);
  ...
  public getHeadings = () => {
    console.log(`40_index.tsx_getHeadings`);
    return getHeadings(this.view.state.doc);
  };

  public getTasks = () => {
    console.log(`41_index.tsx_getTasks`);
    return getTasks(this.view.state.doc);
  };

  public render() {
    console.log(`42_index.tsx_render`);
    const {
      dir,
      readOnly,
